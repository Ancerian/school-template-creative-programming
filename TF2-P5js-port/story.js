const story = {
  ...
  security: {
    background: "images/2сцена 2А1/a-room-with-computers-and-a-map-of-the-world-on-the-wall_902846-42603.jpg",
  ...
  hacker: {
    background: "images/Дизайн без названия (6).png",
  ...
  system_feedback_jolt: {
    background: "images/Дизайн без названия (6).png", // Возможно, другой фон для эффекта
  ...
  id: {
    background: "images/2сцена 2А1/список входов.png",
  ...
  protein: {
    background: "images/2 сцена 2Ф2/Протеиновый гель.png",
  ...
  shaker: {
    background: "images/Дизайн без названия (7).png",
  ...
  initial_findings_review_normal: {
    background: "images/Дизайн без названия (8).png",
  ...
  enginer_normal: {
    background: "images/3СЦЕНА СОЛДАТ/интервью с солдатом.png",
  ...
  investigation_normal: {
    background: "images/4СЦЕН ЖУРНАЛ И МАСТЕРСКАЯ/мастерская инженеера сейф+тетрадка.png",
  ...
  medic_normal: {
    background: "images/4СЦЕН ЖУРНАЛ И МАСТЕРСКАЯ/дорожка тетрадка инженера.png",
  ...
  safe_normal: {
    background: "images/4СЦЕН ЖУРНАЛ И МАСТЕРСКАЯ/Открытый сейф внутри форма.png",
  ...
  final_normal: {
    background: "images/Дизайн без названия (2).png", // Возможно, фон другой для тайной комнаты
  ...
  // --- ОБЫЧНЫЕ КОНЦОВКИ ---
  endingA: {
    background: "images/Дизайн без названия (9).png", // Финальный фон
  ...
  endingA_post: {
    background: "images/Дизайн без названия (10).png", // Тот же фон или другой для эпилога
  ...
  endingB: {
    background: "images/Дизайн без названия (10).png", // Финальный фон
  ...
  endingC: {
    background: "images/Дизайн без названия (11).png", // Финальный фон
  ...
  endingC_post: {
    background: "images/Дизайн без названия (11).png", // Тот же фон или другой для эпилога
  ...
  investigation_secret: {
    background: "images/4СЦЕН ЖУРНАЛ И МАСТЕРСКАЯ/мастерская разведчик сейф или тетрадка.png", // Тот же фон, но другая сцена
  ...
  medic_secret: {
    background: "images/4СЦЕН ЖУРНАЛ И МАСТЕРСКАЯ/мастерская разведчик сейф или тетрадка.png", // Возможно, другой фон
  ...
  safe_secret: {
    background: "images/Дизайн без названия (12).png",
  ...
  secret_ending_scene: {
    background: "images/Дизайн без названия (13).png", // Возможно, уникальный фон для этого состояния
  ...
  endingSecret: {
    background: "images/Дизайн без названия (13).png", // Финальный фон
  ...
  endingSecret_post: {
    background: "images/Дизайн без названия (13).png", // Тот же фон или другой для эпилога
